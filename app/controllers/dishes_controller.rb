class DishesController < ApplicationController
  def index
    ...
    @dishes = @q.result(:distinct => true).includes(:menu_items, :cuisine, :favorites, :venues).page(params[:page]).per(10)
  ...
  def create
    ...
    @dish.name_of_dishes = params[:name_of_dishes]
    @dish.cuisine_id = params[:cuisine_id]
    @dish.favorites_id = params[:favorites_id]
